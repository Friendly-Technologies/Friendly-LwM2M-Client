...
**LWM2M_SUPPORT_CBOR** - enable CBOR payload support (default: **ON**)<br />
**LWM2M_SUPPORT_SENML_CBOR** - enable SenML CBOR payload support (default: **ON**)<br />
...
**LWM2M_WITH_LOGS** - enable logs for wakaama core (default: **ON**)<br />
