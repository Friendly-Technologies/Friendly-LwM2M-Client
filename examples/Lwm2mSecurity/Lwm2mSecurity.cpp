...
void Lwm2mSecurityImpl::init(Object &obj) {
	...
	wpp::Instance *inst0 = obj.createInstance(0);
        ...
        inst0->set<BOOL_T>(Lwm2mSecurity::BOOTSTRAP_SERVER_1, true);
        inst0->set<INT_T>(Lwm2mSecurity::CLIENT_HOLD_OFF_TIME_11, 10);
        #if DTLS_WITH_PSK
        ...
        #elif DTLS_WITH_RPK
            url += "5684";
            inst0->set<INT_T>(Lwm2mSecurity::SECURITY_MODE_2, LWM2M_SECURITY_MODE_RAW_PUBLIC_KEY);
        ...
        #else
            url += "5683";
            inst0->set<INT_T>(Lwm2mSecurity::SECURITY_MODE_2, LWM2M_SECURITY_MODE_NONE);
        #endif
        inst0->set<BOOL_T>(Lwm2mSecurity::BOOTSTRAP_SERVER_1, false);
    #endif

    inst0->set<STRING_T>(Lwm2mSecurity::LWM2M_SERVER_URI_0, url);
    inst0->set<INT_T>(Lwm2mSecurity::SHORT_SERVER_ID_10, TEST_SERVER_SHORT_ID);
}
