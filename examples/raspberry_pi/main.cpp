...
int main() {
	...
	#endif
	cout << endl << "---- Initialization wpp DigitalOutput ----" << endl;
	digitalOutputInit(*client);
	cout << endl << "---- Initialization wpp PushButton ----" << endl;
	pushButtonInit(*client);
	cout << endl << "---- Initialization wpp MKI217 ----" << endl;
	mki217Init(*client);
