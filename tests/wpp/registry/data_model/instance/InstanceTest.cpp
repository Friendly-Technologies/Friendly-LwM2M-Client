...
public:
    ...
    // std::string lwm2mDataToResource() const { return lwm2mDataToResource(lwm2m_data_t &data, Resource &res, ID_T instanceId); }
...
//         // REQUIRE(instance.lwm2mDataToResource((STRING_T)"test1", 0, 0));
...
//         TIME_T time = 123;
//         INT_T intVal = 123;
//         REQUIRE(instance.set(0, 0));
//         REQUIRE(instance.set(1, 0));
//         REQUIRE(instance.set(2, 0));
//         REQUIRE(instance.set(3, 0));
//         REQUIRE(instance.set(3, 1));
//         EXECUTE_T exec = (EXECUTE_T)[](Instance & inst, ID_T id, const OPAQUE_T &data) { return true; };
//         REQUIRE(instance.set(4, 4));
