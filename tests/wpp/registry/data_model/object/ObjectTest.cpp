...
public:
    ...
    Instance *createInstance(ID_T instanceID = ID_T_MAX_VAL)
    {
...
TEST_CASE("Object: instance creating/removing", "[createInstance][createInstanceSpec][remove][clear][instanceCnt][isExist][restore]")
{
    ObjectSpecMock obj(mockContext, mockInfo);
