...
//     // ItemOp(ItemOp::READ | ItemOp::WRITE | ItemOp::DISCOVER | ItemOp::EXECUTE | ItemOp::DELETE),
// };
...
// {
// public:
//     ObjectMock(lwm2m_context_t &context, ObjectInfo &mockInfo) : Object(context, mockInfo) : _context(context), _objInfo(mockInfo){};
//     // ~ObjectMock(){};

//     Instance *createInstance(ID_T instanceID) { return 0; }

//     Instance *instance(ID_T instanceID = 0) { return Object::instance(instanceID); }

//     lwm2m_context_t &getContext() { return _context; }

//     WppClient &getClient() { return *static_cast<wpp::WppClient *>(getContext()->userData); }
...
// {
//     ObjectMock obj(mockContext, mockInfo);
...
//         REQUIRE(lwm2mObj.readFunc == NULL);     // TODO
//         REQUIRE(lwm2mObj.discoverFunc == NULL); // TODO
//         REQUIRE(lwm2mObj.writeFunc == NULL);    // TODO
//         REQUIRE(lwm2mObj.executeFunc == NULL);  // TODO
//         REQUIRE(lwm2mObj.createFunc != NULL);   // TODO
//         REQUIRE(lwm2mObj.deleteFunc != NULL);   // TODO

//         ObjectInfo constrainedObjInfo = mockInfo;
//         constrainedObjInfo.operations = ItemOp(ItemOp::NONE);
//         ObjectMock constrainedObj(mockContext, constrainedObjInfo);
...
// // TEST_CASE("Object: instance creating/removing", "[createInstance][createInstance][remove][clear][instanceCnt][isExist][restore]")
// // {
// //     ObjectMock obj(mockContext, mockInfo);
...
// //     REQUIRE(obj.remove(0));
// //     REQUIRE_FALSE(obj.isExist(0));
// //     REQUIRE(obj.instanceCnt() == 4);
// //     REQUIRE_FALSE(obj.remove(0));
// //     REQUIRE(obj.instanceCnt() == 4);
// //     REQUIRE(obj.remove(1));
// //     REQUIRE_FALSE(obj.isExist(1));
// //     REQUIRE(obj.instanceCnt() == 3);
// //     REQUIRE(obj.remove(2));
// //     REQUIRE_FALSE(obj.isExist(2));
// //     REQUIRE(obj.instanceCnt() == 2);
// //     REQUIRE(obj.remove(3));
// //     REQUIRE_FALSE(obj.isExist(3));
// //     REQUIRE(obj.instanceCnt() == 1);
// //     REQUIRE(obj.remove(4));
// //     REQUIRE_FALSE(obj.isExist(4));
...
// // TEST_CASE("Object: instance accessing", "[instance][instance][getInstances]")
// // {
// //     ObjectMock obj(mockContext, mockInfo);
// //     ObjActObserverTest actObserver;
// //     obj.actSubscribe(&actObserver);
...
// //         const std::vector<Instance *> &instances = obj.instances();
...
// //     {
// //         ObjectMock obj1(mockContext, mockInfo);
// //         for (int i = 0; i < ID_T_MAX_VAL; i++)
// //         {
// //             REQUIRE(obj1.createInstance(i) != NULL);
// //         }
// //         REQUIRE(obj1.instanceCnt() == ID_T_MAX_VAL);
// //         REQUIRE(obj1.createInstance(0) == NULL);
// //         REQUIRE(obj1.instanceCnt() == ID_T_MAX_VAL);

// //         ObjectMock obj2(mockContext, mockInfo);
...
// //         Instance *inst = obj2.createInstance(0);
// //         REQUIRE(inst != NULL);
// //         REQUIRE(inst->getInstanceID() == 1);
// //         inst = obj2.createInstance(0);
// //         REQUIRE(inst != NULL);
...
// //     lwm2m_object_t &lwm2mObj = obj.getLwm2mObject();
// //     REQUIRE(obj.createInstance(0) != NULL);
// //     REQUIRE(lwm2mObj.readFunc(&mockContext, &mockServer, 0, NULL, NULL, &lwm2mObj) == COAP_500_INTERNAL_SERVER_ERROR);
// //     REQUIRE(lwm2mObj.readFunc(&mockContext, &mockServer, 1, NULL, NULL, &lwm2mObj) == COAP_404_NOT_FOUND);
// // }
...
// //     lwm2m_object_t &lwm2mObj = obj.getLwm2mObject();
// //     REQUIRE(obj.createInstance(0) != NULL);
// //     REQUIRE(lwm2mObj.writeFunc(&mockContext, &mockServer, 0, 0, NULL, &lwm2mObj, LWM2M_WRITE_PARTIAL_UPDATE) == COAP_204_CHANGED);
// //     REQUIRE(lwm2mObj.writeFunc(&mockContext, &mockServer, 0, 1, NULL, &lwm2mObj, LWM2M_WRITE_PARTIAL_UPDATE) == COAP_500_INTERNAL_SERVER_ERROR);
// //     REQUIRE(lwm2mObj.writeFunc(&mockContext, &mockServer, 1, 0, NULL, &lwm2mObj, LWM2M_WRITE_PARTIAL_UPDATE) == COAP_404_NOT_FOUND);
// // }
...
// //     lwm2m_object_t &lwm2mObj = obj.getLwm2mObject();
// //     REQUIRE(obj.createInstance(0) != NULL);
// //     REQUIRE(lwm2mObj.executeFunc(&mockContext, &mockServer, 0, 0, NULL, 0, &lwm2mObj) == COAP_404_NOT_FOUND);
// //     REQUIRE(lwm2mObj.executeFunc(&mockContext, &mockServer, 1, 0, NULL, 0, &lwm2mObj) == COAP_404_NOT_FOUND);
// // }
...
// //     lwm2m_object_t &lwm2mObj = obj.getLwm2mObject();
// //     REQUIRE(obj.createInstance(0) != NULL);
// //     REQUIRE(lwm2mObj.discoverFunc(&mockContext, &mockServer, 0, NULL, NULL, &lwm2mObj) == COAP_500_INTERNAL_SERVER_ERROR);
// //     REQUIRE(lwm2mObj.discoverFunc(&mockContext, &mockServer, 1, NULL, NULL, &lwm2mObj) == COAP_404_NOT_FOUND);
// // }
...
// //     REQUIRE(obj.instanceCnt() == 0);
// //     lwm2m_object_t &lwm2mObj = obj.getLwm2mObject();
// //     REQUIRE(lwm2mObj.createFunc(&mockContext, &mockServer, 0, 0, NULL, &lwm2mObj) == COAP_201_CREATED);
// //     REQUIRE(obj.instanceCnt() == 1);
// //     REQUIRE(obj.isExist(0));
// //     REQUIRE(opObserver.instanceCreatedCount == 1);

// //     REQUIRE(lwm2mObj.createFunc(&mockContext, &mockServer, 1, 0, NULL, &lwm2mObj) == COAP_201_CREATED);
// //     REQUIRE(obj.instanceCnt() == 2);
// //     REQUIRE(obj.isExist(1));
// //     REQUIRE(opObserver.instanceCreatedCount == 2);

// //     REQUIRE(lwm2mObj.createFunc(&mockContext, &mockServer, 1, 0, NULL, &lwm2mObj) == COAP_500_INTERNAL_SERVER_ERROR);
// //     REQUIRE(opObserver.instanceCreatedCount == 2);

// //     REQUIRE(opObserver.instanceDeletingCount == 0);
// //     REQUIRE(lwm2mObj.createFunc(&mockContext, &mockServer, 2, 1, NULL, &lwm2mObj) == COAP_500_INTERNAL_SERVER_ERROR);
// //     REQUIRE(obj.instanceCnt() == 2);
// //     REQUIRE_FALSE(obj.isExist(2));
...
// //     REQUIRE(lwm2mObj.deleteFunc(&mockContext, &mockServer, 0, &lwm2mObj) == COAP_202_DELETED);
// //     REQUIRE(obj.instanceCnt() == 4);
// //     REQUIRE_FALSE(obj.isExist(0));
// //     REQUIRE(opObserver.instanceDeletingCount == 1);

// //     REQUIRE(lwm2mObj.deleteFunc(&mockContext, &mockServer, 0, &lwm2mObj) == COAP_404_NOT_FOUND);
// //     REQUIRE(obj.instanceCnt() == 4);
// //     REQUIRE(opObserver.instanceDeletingCount == 1);

// //     REQUIRE(lwm2mObj.deleteFunc(&mockContext, &mockServer, 1, &lwm2mObj) == COAP_202_DELETED);
// //     REQUIRE(obj.instanceCnt() == 3);
// //     REQUIRE_FALSE(obj.isExist(1));
// //     REQUIRE(opObserver.instanceDeletingCount == 2);

// //     REQUIRE(lwm2mObj.deleteFunc(&mockContext, &mockServer, 2, &lwm2mObj) == COAP_202_DELETED);
// //     REQUIRE(obj.instanceCnt() == 2);
// //     REQUIRE_FALSE(obj.isExist(2));
// //     REQUIRE(opObserver.instanceDeletingCount == 3);

// //     REQUIRE(lwm2mObj.deleteFunc(&mockContext, &mockServer, 3, &lwm2mObj) == COAP_202_DELETED);
// //     REQUIRE(obj.instanceCnt() == 1);
// //     REQUIRE_FALSE(obj.isExist(3));
// //     REQUIRE(opObserver.instanceDeletingCount == 4);

// //     REQUIRE(lwm2mObj.deleteFunc(&mockContext, &mockServer, 4, &lwm2mObj) == COAP_202_DELETED);
// //     REQUIRE(obj.instanceCnt() == 0);
// //     REQUIRE_FALSE(obj.isExist(4));
// //     REQUIRE(opObserver.instanceDeletingCount == 5);

// //     REQUIRE(lwm2mObj.deleteFunc(&mockContext, &mockServer, 5, &lwm2mObj) == COAP_404_NOT_FOUND);
// //     REQUIRE(obj.instanceCnt() == 0);
// //     REQUIRE(opObserver.instanceDeletingCount == 5);
// // }
// // }