...
FILETYPE_OBJ_IMPL_H = "FILETYPE_OBJ_IMPL_H"
FILETYPE_OBJ_IMPL_CPP = "FILETYPE_OBJ_IMPL_CPP"
FILETYPE_OBJ_CONF = "FILETYPE_OBJ_CONF"
FILETYPE_OBJ_INFO = "FILETYPE_OBJ_NFO"


MAIN_H_COMMENT = \
    f"""/*\n""" \
    f""" * File type: {FILETYPE_OBJ_IMPL_H}  \n""" \
...
MAIN_CPP_COMMENT = \
    f"""/*\n""" \
    f""" * File type: {FILETYPE_OBJ_IMPL_CPP}\n""" \
    f""" * Generated on: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}\n""" \
    f""" * Author: valentin\n""" \
    f""" * Generated by: Vadimzakreva\n""" \
    f""" */\n\n"""
