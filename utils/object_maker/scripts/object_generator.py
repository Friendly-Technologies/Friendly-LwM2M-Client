...
FILE_PATH_TYPE_OBJ_IMPL_H = f"./file_templates/{FILE_TYPE_OBJ_IMPL_H}.txt"
FILE_PATH_TYPE_OBJ_IMPL_CPP = f"./file_templates/{FILE_TYPE_OBJ_IMPL_CPP}.txt"
...
class ObjectGenerator:
    ...
    def generate_content_header(self):
        ...
        data_str_h = data_str_h.replace("__MAIN_COMMENT__", MAIN_H_COMMENT)
    ...
    def generate_content_cpp(self):
        ...
        data_str_cpp = data_str_cpp.replace("__MAIN_COMMENT__", MAIN_CPP_COMMENT)
