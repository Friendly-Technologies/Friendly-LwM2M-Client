...
if (LWM2M_SUPPORT_SENML_JSON)
    set(WAKAAMA_CORE_DEFINITIONS ${WAKAAMA_CORE_DEFINITIONS} LWM2M_SUPPORT_SENML_JSON=1)
endif()

option(LWM2M_SUPPORT_JSON "Enable JSON payload support" OFF)
if (LWM2M_SUPPORT_JSON)
    set(WAKAAMA_CORE_DEFINITIONS ${WAKAAMA_CORE_DEFINITIONS} LWM2M_SUPPORT_JSON=1)
endif()

option(LWM2M_SUPPORT_TLV "Enable TLV payload support" OFF)
if (LWM2M_SUPPORT_TLV)
    set(WAKAAMA_CORE_DEFINITIONS ${WAKAAMA_CORE_DEFINITIONS} LWM2M_SUPPORT_TLV=1)
endif()
...
if (LWM2M_OLD_CONTENT_FORMAT_SUPPORT)
    set(WAKAAMA_CORE_DEFINITIONS ${WAKAAMA_CORE_DEFINITIONS} LWM2M_OLD_CONTENT_FORMAT_SUPPORT=1)
endif()

option(LWM2M_VERSION_1_0 "Support only version 1.0" OFF)
if (LWM2M_VERSION_1_0)
    set(WAKAAMA_CORE_DEFINITIONS ${WAKAAMA_CORE_DEFINITIONS} LWM2M_VERSION_1_0=1)
endif()
...
set(WAKAAMA_CORE_DEFINITIONS ${WAKAAMA_CORE_DEFINITIONS} PARENT_SCOPE=1)