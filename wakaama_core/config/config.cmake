...
if (LWM2M_BOOTSTRAP)
    set(COMPILE_DEFINITIONS ${COMPILE_DEFINITIONS} LWM2M_BOOTSTRAP)
endif()

option(LWM2M_SUPPORT_SENML_JSON "Enable SenML JSON payload support" ON)
if (LWM2M_SUPPORT_SENML_JSON)
    set(COMPILE_DEFINITIONS ${COMPILE_DEFINITIONS} LWM2M_SUPPORT_SENML_JSON)
endif()

option(LWM2M_SUPPORT_JSON "Enable JSON payload support" OFF)
if (LWM2M_SUPPORT_JSON)
    set(COMPILE_DEFINITIONS ${COMPILE_DEFINITIONS} LWM2M_SUPPORT_JSON)
endif()

option(LWM2M_SUPPORT_TLV "Enable TLV payload support" OFF)
if (LWM2M_SUPPORT_TLV)
    set(COMPILE_DEFINITIONS ${COMPILE_DEFINITIONS} LWM2M_SUPPORT_TLV)
endif()
...
if (LWM2M_OLD_CONTENT_FORMAT_SUPPORT)
    set(COMPILE_DEFINITIONS ${COMPILE_DEFINITIONS} LWM2M_OLD_CONTENT_FORMAT_SUPPORT)
endif()

option(LWM2M_VERSION_1_0 "Support only version 1.0" OFF)
if (LWM2M_VERSION_1_0)
    set(COMPILE_DEFINITIONS ${COMPILE_DEFINITIONS} LWM2M_VERSION_1_0)
endif()
...
if (LWM2M_RAW_BLOCK1_REQUESTS)
    set(COMPILE_DEFINITIONS ${COMPILE_DEFINITIONS} LWM2M_RAW_BLOCK1_REQUESTS)
endif()
...
set(COMPILE_DEFINITIONS ${COMPILE_DEFINITIONS} LWM2M_COAP_DEFAULT_BLOCK_SIZE=1024)
...
# set(COMPILE_DEFINITIONS ${COMPILE_DEFINITIONS} LWM2M_BIG_ENDIAN)
# If your target platform uses little-endian format
# set(COMPILE_DEFINITIONS ${COMPILE_DEFINITIONS} LWM2M_LITTLE_ENDIAN)
