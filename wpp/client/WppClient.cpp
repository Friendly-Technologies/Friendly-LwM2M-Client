...
WppClient::WppClient(const ClientInfo &info, IWppConnection &connection, const WppRegistry::OBJ_RESTORE_T &objRestoreFunc): _connection(connection), _registry(objRestoreFunc) {
	lwm2mContextOpen();
