...
WppConnection *WppConnection::_core = NULL;
...
bool WppConnection::create(CONNECT_T &connectClb, DISCONNECT_T &disconnectClb, SESSION_CMP_T &sessionCmpClb, SEND_T &sendClb) {
	...
	_core = new WppConnection(connectClb, disconnectClb, sessionCmpClb, sendClb);
	return true;
}
...
bool WppConnection::sessionCmp(SESSION_T session1, SESSION_T session2) {
...
extern "C" {
	...
	bool lwm2m_session_is_equal(void * session1, void * session2, void * userData) {
		...
		return wpp::WppConnection::instance()->sessionCmp(session1, session2);
	}
}
