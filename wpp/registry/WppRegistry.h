...
namespace wpp {
/*
 * To interact with the registry, it is necessary to take ownership of it,
 * even if control was transferred from the registry to the user-registered
...
public:
	 ...
	 * This is due to the fact that these interfaces are not the initial registry
	 * usage points.
	 */
	...
	void restoreObject(WppRegistry &registry, Lwm2mObject &object);
