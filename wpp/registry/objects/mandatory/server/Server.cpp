...
std::vector<Resource *> Server::getResourcesList(const ResOperation& filter) {
	std::vector<Resource *> list;
...
std::vector<Resource *> Server::getInstantiatedResourcesList(const ResOperation& filter) {
	std::vector<Resource *> list;
	for (auto &pair : _resources) {
...
void Server::serverOperationNotifier(ResOperation::TYPE type, const ResLink &resId) {
...
void Server::userOperationNotifier(ResOperation::TYPE type, const ResLink &resId) {
	switch (type) {
	case ResOperation::READ:
